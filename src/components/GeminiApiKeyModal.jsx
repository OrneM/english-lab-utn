...
export function GeminiApiKeyModal({ isOpen, onClose, onKeyUpdated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div className="w-full max-w-lg rounded-3xl glass-card border border-brand-500/30 p-6 sm:p-8 space-y-6 shadow-2xl relative overflow-hidden animate-slide-up">
        
        {/* Glow ambient background */}
        <div className="absolute -top-24 -right-24 w-48 h-48 bg-brand-500/20 rounded-full blur-3xl pointer-events-none"></div>
        <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-cyanBrand-500/20 rounded-full blur-3xl pointer-events-none"></div>

        {/* Modal Header */}
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center space-x-3">
            <div className="p-2.5 rounded-2xl bg-gradient-to-br from-brand-500/20 to-cyanBrand-500/20 border border-brand-500/30 text-brand-300">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Preguntas inéditas y Arthur con IA en tiempo real</p>
            </div>
          </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-2.5 text-xs text-slate-300">
          <span className="font-bold text-slate-200 uppercase tracking-wider text-[11px] block text-cyanBrand-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1">
            ...
            <div className="flex items-start space-x-2">
              <Bot className="w-4 h-4 text-brand-400 flex-shrink-0 mt-0.5" />
        ...
        <div className="space-y-3">
          <label className="text-xs font-bold text-slate-300 uppercase tracking-wider flex items-center justify-between">
            <span className="flex items-center space-x-1.5">
              <Key className="w-3.5 h-3.5 text-cyanBrand-400" />
          ...
          <div className="relative">
            <input
              ...
              className="w-full py-3 px-4 rounded-xl bg-slate-900 border border-slate-700 focus:border-cyanBrand-400 focus:ring-1 focus:ring-cyanBrand-400 text-slate-100 font-mono text-xs sm:text-sm placeholder-slate-500"
            />
          </div>
          ...
          <div className="flex items-center space-x-2 pt-1">
            ...
            >
              {isTesting ? (
                ...
                <>
                  ...
                  <span>Guardar y Activar Gemini</span>
                </>
              )}
            </button>
            ...
            {isSaved && (
              <button
                ...
                className="p-3 rounded-xl border border-slate-800 bg-slate-900 hover:bg-rose-950/40 hover:border-rose-500/40 text-slate-400 hover:text-rose-400 transition-colors"
              >
        ...
        <div className="p-4 rounded-2xl bg-slate-950/90 border border-slate-800/90 space-y-2.5 text-xs">
          <div className="flex items-center justify-between text-slate-300 font-bold">
            ...
            <a
              ...
              className="text-cyanBrand-400 hover:text-cyanBrand-300 flex items-center space-x-1 font-semibold"
            >
          ...
          <ol className="list-decimal list-inside space-y-1.5 text-slate-400 text-[11px] leading-relaxed">
            <li>Ingresa gratis a <a href="https://aistudio.google.com/app/apikey" target="_blank" rel="noopener noreferrer" className="text-cyanBrand-400 underline">aistudio.google.com</a> con tu cuenta de Google.</li>
